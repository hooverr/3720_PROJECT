...
<script type="text/javascript">
		...
		for (var dayIncrement = 0; dayIncrement < numDays; dayIncrement++) {
			...
			switch (day) {
					...
					if (dayIncrement != 0) {
						...
						for(var docIncrement = 0; docIncrement < doctors.length; docIncrement++) {
							if(doctors[docIncrement][0] == prevDocID) {
								// increment doctors total days worked
								doctors[docIncrement][2] = (parseInt(doctors[docIncrement][2]) + 1).toString();
								// increment doctors real days worked
								doctors[docIncrement][7] = (parseInt(doctors[docIncrement][7]) + 1).toString();
								break;
							}
						}
				...
				case 1: //Monday
					if (holiday || wEndHoliday) {
						if (dayIncrement != 0) {
							...
							for(var docIncrement = 0; docIncrement < doctors.length; docIncrement++) {
								if(doctors[docIncrement][0] == prevDocID) {
									doctors[docIncrement][1] = (parseInt(doctors[docIncrement][1]) + 1).toString();
									doctors[docIncrement][6] = (parseInt(doctors[docIncrement][6]) + 1).toString();
									break;
								}
							}
						...
						docSorted[docPosition][3] = (parseInt(docSorted[docPosition][3]) + 1).toString();
						docSorted[docPosition][8] = (parseInt(docSorted[docPosition][8]) + 1).toString();
				...
				case 4: //Thurday
					...
					sched[dayIncrement] = docSorted[docPosition][0];
					if (holiday){
						docSorted[docPosition][1] = (parseInt(docSorted[docPosition][1]) + 1).toString();
						docSorted[docPosition][6] = (parseInt(docSorted[docPosition][6]) + 1).toString();
					}
					else {
						docSorted[docPosition][3] = (parseInt(docSorted[docPosition][3]) + 1).toString();
						docSorted[docPosition][8] = (parseInt(docSorted[docPosition][8]) + 1).toString();
	...
	*/
	function increment(doctors, docPosition, dayType) {
		switch(dayType){
			case 'weekday':
				doctors[docPosition][3] = (parseInt(doctors[docPosition][3]) + 1).toString();
				doctors[docPosition][8] = (parseInt(doctors[docPosition][8]) + 1).toString();
				break;
			case 'weekend':
				doctors[docPosition][2] = (parseInt(doctors[docPosition][2]) + 1).toString();
				doctors[docPosition][7] = (parseInt(doctors[docPosition][7]) + 1).toString();
				break;
			case 'holiday':
				doctors[docPosition][1] = (parseInt(doctors[docPosition][1]) + 1).toString();
				doctors[docPosition][6] = (parseInt(doctors[docPosition][6]) + 1).toString();
				break;
		}
